 ...
 getUser()
  ...
  return (
    ...
    <div className="background-container">
     <img className="cover-photo" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTDzwpnBdzmNIX7zHmfR-qe81AInhPMllGxfA&usqp=CAU"/>
     <div className="user-avatar">
</div>
<div className="search-user-info">
     <Btn color="#fff" bgColor="#fd683d"icon={<AiOutlineSearch/>}bdRadius="20px"/></div>
     </div>
...
<UserName/>
 ...
 <AvartaGroup info="Post"num={1370}></AvartaGroup> 
     ...
     <Btn text="Add to story" icon={<AiFillPlusCircle/>} bgColor="#fd683d"color="#fff" bdRadius="10px"/>
     <Btn bgColor="rgba(0,0,0,.1)"text="Edit profile"icon={<MdModeEdit/>} bdRadius="10px"/>
     <Btn text={null}bgColor="rgba(0,0,0,.1)"to="" icon={<BsThreeDots/>} bdRadius="10px"/>
