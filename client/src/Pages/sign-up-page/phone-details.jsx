...
const UserCountryInfo = () => {
  ...
  const [selectedImag, setSelectedImg] = useState(
    "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQGTWshZmnX0n-tCBKEuPpDLZMFFzwWN7FQoQ&usqp=CAU"
  );
      ...
      <div>
        <div className="sign-in-form-container">
          ...
          <div className="form-container">
                  ...
                  <div className="details-wrapper">
                    <div>
                      <div
                        ...
                        onClick={handleShowListOfCountry}
                      >
                    ...
                    <div
                      className="user-phone-number-controller"
                      onClick={() => {
            ...
            <div id="next">
              <button>
                <Link to="/register/userinfo">Next</Link>
              </button>
            </div>
          </div>
        </div>
